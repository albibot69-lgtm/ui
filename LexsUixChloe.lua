...
local ConfigFile = "LexsHub/Config/LexsHub_" .. gameName .. ".json"
...
function CircleClick(Button, X, Y)
    spawn(function()
        ...
        Circle.Image = "rbxassetid://103875081318049"
...
function LexsHub:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(0, 229, 255)
...
function LexsHub:Window(GuiConfig)
    ...
    GuiConfig.Footer = GuiConfig.Footer or "LexsHub"
    ...
    LexsHubUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    LexsHubUI.Name = "LexsHub"
    LexsHubUI.ResetOnSpawn = false
    LexsHubUI.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = LexsHubUI
    ...
    local LexsHubButton = Instance.new("ScreenGui")
    local Button = Instance.new("ImageButton")
    local Corner = Instance.new("UICorner")
    local Scale = Instance.new("UIScale")

    StreeHubButton.Name = "LexsHubButton"
